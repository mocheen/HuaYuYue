...
func newUserRole(db *gorm.DB, opts ...gen.DOOption) userRole {
	...
	_userRole.userRoleDo.UseModel(&repository.UserRole{})
...
type IUserRoleDo interface {
	...
	Create(values ...*repository.UserRole) error
	CreateInBatches(values []*repository.UserRole, batchSize int) error
	Save(values ...*repository.UserRole) error
	First() (*repository.UserRole, error)
	Take() (*repository.UserRole, error)
	Last() (*repository.UserRole, error)
	Find() ([]*repository.UserRole, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*repository.UserRole, err error)
	FindInBatches(result *[]*repository.UserRole, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*repository.UserRole) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*repository.UserRole, error)
	FirstOrCreate() (*repository.UserRole, error)
	FindByPage(offset int, limit int) (result []*repository.UserRole, count int64, err error)
...
func (u userRoleDo) Create(values ...*repository.UserRole) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userRoleDo) CreateInBatches(values []*repository.UserRole, batchSize int) error {
	return u.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (u userRoleDo) Save(values ...*repository.UserRole) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userRoleDo) First() (*repository.UserRole, error) {
	if result, err := u.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*repository.UserRole), nil
	}
}

func (u userRoleDo) Take() (*repository.UserRole, error) {
...
func (u userRoleDo) Last() (*repository.UserRole, error) {
...
func (u userRoleDo) Find() ([]*repository.UserRole, error) {
	result, err := u.DO.Find()
	return result.([]*repository.UserRole), err
}

func (u userRoleDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*repository.UserRole, err error) {
	buf := make([]*repository.UserRole, 0, batchSize)
...
func (u userRoleDo) FindInBatches(result *[]*repository.UserRole, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (u userRoleDo) FirstOrInit() (*repository.UserRole, error) {
...
func (u userRoleDo) FirstOrCreate() (*repository.UserRole, error) {
...
func (u userRoleDo) FindByPage(offset int, limit int) (result []*repository.UserRole, count int64, err error) {
...
func (u userRoleDo) Delete(models ...*repository.UserRole) (result gen.ResultInfo, err error) {
